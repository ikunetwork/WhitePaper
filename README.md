...
**Figure A: Return on Investment in Pharma R&D** ![Return on Investment in Pharma R&amp;D](https://github.com/ikunetwork/WhitePaper/blob/master/ReturnOnInvestmentOnPharmaRD.png)
...
Once a smart contract is set in motion, the blockchain is utilized to serve as an independent third party to make sure agreements are executed.[16](./#f16) Efficiency increases, allowing for new markets where too much overhead was previously required for trade and/or there was previously little exchange of information due to lack of trust \(e.g. litigation\).[17](./#f17) No third party is needed for escrow. Money is guaranteed to flow on contract resolution without the need to sue - smart contracts provide justice without judges.
...
Typically, by the time a NME is ready to enter clinical trial, there is &lt; 10 years left of patent life, often times only 5-6 years.[18](./#f18) Jurisdictions throughout the world, including U.S., EU and Asia provide market/data exclusivity periods \(independent of patents\) for clinical trial data, regardless if NME or not, for up to ~10 years.[19](./#f19) Generic medicines are built on the same active ingredients \(as the patented drugs\) once their patents or marketing exclusivities have expired.[20](./#f20) They have the same dosage, effectiveness and - safety - profile as the original drug.[21](./#f21) By definition, once the generic forms can be sold, the ingredient is on the market for many years and as such, generics themeselves are considered safe for patients.[22](./#f22) Because their patents have expired, there is significantly less risk of infringement and significant freedom to operate.
