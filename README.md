...
IKU employs the blockchain and smart contracts to collapse capital, copyrights to R&D data sets (a layer abstract from patents) and execution into one providing for a digital, global, auction-based market infrastructure in which R&D/clinical trials can scale. Global R&D smart contract auctions allow for a liquid R&D economy to improve capital formation, realization of pent up demand for biotechnology and ultimately significantly increase the marginal return on lifespan per unit of research advancement. This paper explains (i) the deficiencies of the current legacy R&D model, (ii) the mission of creating a digitally, liquid global market to scale bio R&D/trials and (iii) how IKU ultimately compounds value through global arbitrage to push science and medicine to boundaries yet unseen. 
